...
for i, j in lbl_files.iterrows():
    ...
    if tags:
        [signal, fs] = sf.read(wav_path + j['wav'] + '.wav')
        ...
        for l, m in k.iterrows():
            ...
            file_out = output_path+str(j['wav'])+'_'+str(l)+'.wav'
